...
public class PresentationToModelIntents {
  ...
  public static final String ACTION_REQUEST_SNOOZE =
          BuildConfigCustom.APPLICATION_ID + ".model.interfaces.ServiceIntents.ACTION_REQUEST_SNOOZE";
  public static final String ACTION_REQUEST_DISMISS =
          BuildConfigCustom.APPLICATION_ID + ".model.interfaces.ServiceIntents.ACTION_REQUEST_DISMISS";
  public static final String ACTION_REQUEST_SKIP =
          BuildConfigCustom.APPLICATION_ID + ".model.interfaces.ServiceIntents.ACTION_REQUEST_SKIP";
